...
class OfficeLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office_location" do
    assert_difference('OfficeLocation.count') do
      post office_locations_url, params: { office_location: { phone: @office_location.phone, street_address: @office_location.street_address, zip: @office_location.zip } }
    end
  ...
  test "should update office_location" do
    patch office_location_url(@office_location), params: { office_location: { phone: @office_location.phone, street_address: @office_location.street_address, zip: @office_location.zip } }
